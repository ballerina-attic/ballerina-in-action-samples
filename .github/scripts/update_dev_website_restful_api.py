...
def main():
    with open('restful_api/restful_api.bal', 'r') as action_obj:
        updated_bal_file = action_obj.read()
        with open('restful-api.md', 'a') as write_obj:
            write_obj.write("```\n")
    ...
    with open('restful-api.md','r') as commit_obj:
    ...
    try:
        ...
        if update:
            ...
            head_branch = 'update-restful-api'
